...
print("Click on the 'X' to see how base pay salary differs between men and women with a masters degree.")
...
print("Click on the 'X' to see how initial salary differs between gender of those who have a college undergraduate degree.\n")
...
print("Click on the 'X' to see how initial salary differs between gender of those who have a high school degree.\n")
...
print("Click on the 'X' to read the conclusion of my data analysis.\n")
